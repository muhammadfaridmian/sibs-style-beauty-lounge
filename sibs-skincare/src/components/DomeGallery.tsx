...
// DomeGallery — React Bits (JS + CSS variant), ported to TypeScript.
// All theming is driven by props so the component can match the salon palette.
...
function buildItems(pool: GalleryImage[], seg: number): BuildItem[] {
...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback(
    (el: HTMLElement) => {
      ...
      lockScroll();
      const parent = el.parentElement;
      if (!parent || !mainRef.current || !frameRef.current || !viewerRef.current || !rootRef.current) {
        openingRef.current = false;
        unlockScroll();
        return;
      }
